  ...
  if (done) {
    return (
      <div className="flex h-full flex-col items-center justify-center py-10 text-center">
        <div className="grid h-14 w-14 place-items-center rounded-full bg-emerald-100 text-2xl text-emerald-600">
          ✓
        </div>
  ...
  return (
    <div>
      ...
      <div className="mt-2 rounded-xl border border-neutral-200 p-6 text-center">
        <p className="font-mono text-3xl font-semibold tracking-wide text-neutral-900">
          {u.code}
        </p>
...
function PayFooter({
  ...
  return (
    <div className="-mx-6 mt-6 border-t border-neutral-100 bg-white/95 px-6 pb-1 pt-5 backdrop-blur sm:mx-0 sm:sticky sm:bottom-0 sm:static sm:px-0">
      ...
      <p className="mt-3 text-center text-[11px] text-neutral-400 sm:hidden">
